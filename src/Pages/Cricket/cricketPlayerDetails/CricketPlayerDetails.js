...
<button class="modal-btn"  type="button">Send</button>
                ...
                <div>
                    ...
                    <img className='details-player-img' src={singleCricket?.img } alt="" />
                </div>
            </Container>
        </div>
        </>
      ...
      <div className='row'>
          ...
          <p style={{marginBottom: "10px", fontSize: "20px", fontWeight: "400", width: "500px"}}>{singleCricket?.describe}</p>
              ...
              <table>
                  <tbody>
                      <tr>
                          ...
                          <td style={{color: "#dc3545", fontWeight: "700", fontSize: "18px"}}>{singleCricket?.Height}</td>
                      </tr>
                      <tr>
                          <td style={{ fontWeight: "600", fontSize: "16px"}}><strong>Weight</strong></td>
                          <td style={{color: "#dc3545", fontWeight: "700", fontSize: "18px"}}>{singleCricket?.Weight}</td>
                      </tr>
                      <tr>
                          <td style={{ fontWeight: "600", fontSize: "16px"}}><strong>Position</strong></td>
                          <td style={{color: "#dc3545", fontWeight: "700", fontSize: "18px"}}>{singleCricket?.Position}</td>
                      </tr>
                      <tr>
                          <td style={{ fontWeight: "600", fontSize: "16px"}}><strong>Nationality</strong></td>
                          <td style={{color: "#dc3545", fontWeight: "700", fontSize: "18px"}}>{singleCricket?.Nationality}</td>
                      </tr>
                  </tbody>
              </table>
          </div>
